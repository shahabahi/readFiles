...
public interface SaleObjectConsumer {
     ...
     */
    void startSaleObjectTransaction(String filePath,PriorityOrderAttribute orderAttribute);
     ...
     */
    void reportSaleObject(int squareMeters, long pricePerSquareMeter, String city, String street, Integer floor) throws TechnicalException;
